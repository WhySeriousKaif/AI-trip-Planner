...
const Hero = () => {
  return (
    <div
      className='flex flex-col items-center px-4 sm:px-6 md:px-8 lg:px-16 xl:px-60 gap-6 md:gap-9 bg-cover bg-center'
      style={{
    ...
    >
      ...
      <p className='  sm:text-lg  md:text-xl text-white text-center mt-4 md:mt-10 max-w-3xl '>
